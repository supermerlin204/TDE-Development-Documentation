...
TDE_DATA.elites = [
  ...
  { id: 'zealot_guardian', name: '卫道士', image: '', faction: 'calamity-legion', desc: '灾厄军团的中坚力量。身披厚重黑甲，手持燃烧的灾厄大锤，攻击缓慢但无法格挡。死亡时会引爆体内的灾厄之力，对周围造成范围伤害。', lore: '卫道士曾是低语避难所最虔诚的守夜骑士。当无眠诅咒蔓延至他的家乡，他目睹了祈祷与圣光都无法拯救任何人的残酷现实。绝望之中，他转而信仰了"毁灭即净化"的教条——如果连神都无法阻止这场灾难，那么唯有将一切焚烧殆尽，才能在灰烬中重建新的秩序。如今他身披黑甲，手中的战锤燃烧着昔日信仰的残渣，每一次挥击都是对曾经信念的否定。', location: '灾厄前线', hp: '3,200' }
];
